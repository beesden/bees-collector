...
@Component({
  ...
  template: `
    ...
    <div class="completion">
      ...
      <ion-icon name="briefcase" [color]="figure.accessories ? 'green' : 'red'"></ion-icon>
...
export class FigureCardComponent {
  ...
  get image(): SafeStyle {
    return this.sanitizer.bypassSecurityTrustStyle(`url(${this.figure.image ? this.figure.image[0] : this.defaultImage || this.defaultImage})`);
  }
